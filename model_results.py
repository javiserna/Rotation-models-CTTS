...
if __name__ == '__main__':
    ...
    for tbin in ages:
        if tbin==0.5:
            ...
            plot_="./Plots/bin1_vsini_posterior.png"
            plot_2="./Plots/bin1_B_posterior.png"
            plot_3="./Plots/bin1_Prot_posterior.png"
            plot_4="./Plots/bin1_Macc_posterior.png"
        ...
        if tbin==1.5:
            ...
            plot_="./Plots/bin2_vsini_posterior.png"
            plot_2="./Plots/bin2_B_posterior.png"
            plot_3="./Plots/bin2_Prot_posterior.png"
            plot_4="./Plots/bin2_Macc_posterior.png"
        ...
        if tbin==2.5:
            ...
            plot_="./Plots/bin3_vsini_posterior.png"
            plot_2="./Plots/bin3_B_posterior.png"
            plot_3="./Plots/bin3_Prot_posterior.png"
            plot_4="./Plots/bin3_Macc_posterior.png"
        ...
        if tbin==8:
            ...
            plot_="./Plots/bin4_vsini_posterior.png"
            plot_2="./Plots/bin4_B_posterior.png"
            plot_3="./Plots/bin4_Prot_posterior.png"
            plot_4="./Plots/bin4_Macc_posterior.png"
