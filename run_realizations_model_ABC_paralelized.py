...
if tbin==0.5:
    ...
    plot_="./Plots/bin1_vsini_result.png"
...
if tbin==1.5:
    ...
    plot_="./Plots/bin2_vsini_result.png"
...
if tbin==2.5:
    ...
    plot_="./Plots/bin3_vsini_result.png"
...
if tbin==8:
    ...
    plot_="./Plots/bin4_vsini_result.png"
...
if __name__ == '__main__':
    ...
    num_samples = 10  #[62 68 40 30] # Change this to the number of samples you want
    num_processes = 10  # Adjust the number of processes as needed
    repetitions = 10
    result = [[] for _ in range(10)]
    vhis = [[] for _ in range(10)]
    ...
    for k in range(repetitions):
        ...
        for item in results:
            ...
            result[k].append(np.c_[Protin, Maccin, B])
            vhis[k].append(value)
