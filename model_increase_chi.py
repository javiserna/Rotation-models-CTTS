...
if __name__ == '__main__':
    ...
    for tbin in ages:
        ...
        if tbin==0.5:
            ...
            cdf_values = norm.cdf(chi, loc=0.1, scale=0.05)
            Bin1_Macc=np.genfromtxt('mdot_bin1_logmdot', comments='#', dtype='S')
            filename_1="./Results/bin1_vsini_result.txt"
            plot_="./Plots/bin1_vsini_model_increase_chi.png"
            plot_2="./Plots/bin1_B_model_increase_chi.png"
            plot_3="./Plots/bin1_Prot_model_increase_chi.png"
            plot_4="./Plots/bin1_Macc_model_increase_chi.png"
        ...
        if tbin==1.5:
            ...
            cdf_values = norm.cdf(chi, loc=0.2, scale=0.05)
            Bin1_Macc=np.genfromtxt('mdot_bin2_logmdot', comments='#', dtype='S')
            filename_1="./Results/bin2_vsini_result.txt"
            plot_="./Plots/bin2_vsini_model_increase_chi.png"
            plot_2="./Plots/bin2_B_model_increase_chi.png"
            plot_3="./Plots/bin2_Prot_model_increase_chi.png"
            plot_4="./Plots/bin2_Macc_model_increase_chi.png"
        ...
        if tbin==2.5:
            ...
            cdf_values = norm.cdf(chi, loc=0.3, scale=0.05)
            Bin1_Macc=np.genfromtxt('mdot_bin3_logmdot', comments='#', dtype='S')
            filename_1="./Results/bin3_vsini_result.txt"
            plot_="./Plots/bin3_vsini_model_increase_chi.png"
            plot_2="./Plots/bin3_B_model_increase_chi.png"
            plot_3="./Plots/bin3_Prot_model_increase_chi.png"
            plot_4="./Plots/bin3_Macc_model_increase_chi.png"
        ...
        if tbin==8:
            ...
            plot_="./Plots/bin4_vsini_model_increase_chi.png"
            plot_2="./Plots/bin4_B_model_increase_chi.png"
            plot_3="./Plots/bin4_Prot_model_increase_chi.png"
            plot_4="./Plots/bin4_Macc_model_increase_chi.png"
        ...
        for k in range(repetitions):
            ...
            random_values_chi = [chi[i] for i in random_chi_samples if i is not None]
            #############################################################################
