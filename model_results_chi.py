...
if __name__ == '__main__':
    ...
    for tbin in ages:
        ...
        if tbin==0.5:
            ...
            plot_="./Plots/bin1_vsini_posterior_chi.png"
            plot_2="./Plots/bin1_B_posterior_chi.png"
            plot_3="./Plots/bin1_Prot_posterior_chi.png"
            plot_4="./Plots/bin1_Macc_posterior_chi.png"
        ...
        if tbin==1.5:
            ...
            plot_="./Plots/bin2_vsini_posterior_chi.png"
            plot_2="./Plots/bin2_B_posterior_chi.png"
            plot_3="./Plots/bin2_Prot_posterior_chi.png"
            plot_4="./Plots/bin2_Macc_posterior_chi.png"
        ...
        if tbin==2.5:
            ...
            plot_="./Plots/bin3_vsini_posterior_chi.png"
            plot_2="./Plots/bin3_B_posterior_chi.png"
            plot_3="./Plots/bin3_Prot_posterior_chi.png"
            plot_4="./Plots/bin3_Macc_posterior_chi.png"
        ...
        if tbin==8:
            ...
            plot_="./Plots/bin4_vsini_posterior_chi.png"
            plot_2="./Plots/bin4_B_posterior_chi.png"
            plot_3="./Plots/bin4_Prot_posterior_chi.png"
            plot_4="./Plots/bin4_Macc_posterior_chi.png"
            filename_2="./Results/bin4_parameters_result.txt"
            databin = np.loadtxt('./Plots/vsini_bin4.txt')

        chi=Bin1_chi[:,0].astype(float)
        cdf_values=Bin1_chi[:,1].astype(float)
        ...
        for k in range(repetitions):
            ...
            chi_=pow(10,chi)
            #############################################################################
            random_chi_samples = [sample_random_x(cdf_values) for _ in range(num_samples)]
            ...
            #############################################################################
            params_list = [(Mass[0], random.choice(Pin), j, Bfield[0], i) for i, j in zip(random_values_chi,random_values_Macc)]
            ...
            for item in results:
                Protin, Maccin, A, value = item
                result[k].append((Protin, Maccin, A))
                vhis[k].append(value)

        result = np.array(result, dtype=object)
        per_histograms = [np.array([item[0] for item in block]) for block in result]
        per = np.concatenate(per_histograms)
        chi_histograms = [np.array([np.log10(item[2]) for item in block]) for block in result]
