...
- 
Measurements of periods in CTTS can be challenging to obtain because of complex brightness variations in the light curves which create quasi-periodic patterns. Despite the challenges, in some cases is possible to get a pure signature of the rotation in the light curve of these objects.
