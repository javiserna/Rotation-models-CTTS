...
def compute(params):
    ...
    if tbin==8:
        value = function(8e6)
    return Protin, Maccin, B, A, value
...
if __name__ == '__main__':
    ...
    ages=[0.5, 1.5, 2.5, 8]
    num_processes = 10#60  # Adjust the number of processes as needed
    repetitions = 3#100
    for tbin in ages:
        ...
        if tbin==0.5:
            ...
            Bin1_chi=np.genfromtxt('bin1_chi.txt', comments='#', dtype='S')
            Bin1_Macc=np.genfromtxt('mdot_bin1_logmdot', comments='#', dtype='S')
            filename_1="./Results/bin1_vsini_result_combined.txt"
            plot_="./Plots/bin1_vsini_posterior_combined.png"
            plot_2="./Plots/bin1_B_posterior_combined.png"
            plot_3="./Plots/bin1_Prot_posterior_combined.png"
            plot_4="./Plots/bin1_Macc_posterior_combined.png"
            plot_5="./Plots/bin1_chi_posterior_combined.png"
            filename_2="./Results/bin1_parameters_result_combined.txt"
        ...
        if tbin==1.5:
            ...
            Bin1_chi=np.genfromtxt('bin2_chi.txt', comments='#', dtype='S')
            Bin1_Macc=np.genfromtxt('mdot_bin2_logmdot', comments='#', dtype='S')
            filename_1="./Results/bin2_vsini_result_combined.txt"
            plot_="./Plots/bin2_vsini_posterior_combined.png"
            plot_2="./Plots/bin2_B_posterior_combined.png"
            plot_3="./Plots/bin2_Prot_posterior_combined.png"
            plot_4="./Plots/bin2_Macc_posterior_combined.png"
            plot_5="./Plots/bin2_chi_posterior_combined.png"
            filename_2="./Results/bin2_parameters_result_combined.txt"
        ...
        if tbin==2.5:
            ...
            Bin1_chi=np.genfromtxt('bin3_chi.txt', comments='#', dtype='S')
            Bin1_Macc=np.genfromtxt('mdot_bin3_logmdot', comments='#', dtype='S')
            filename_1="./Results/bin3_vsini_result_combined.txt"
            plot_="./Plots/bin3_vsini_posterior_combined.png"
            plot_2="./Plots/bin3_B_posterior_combined.png"
            plot_3="./Plots/bin3_Prot_posterior_combined.png"
            plot_4="./Plots/bin3_Macc_posterior_combined.png"
            plot_5="./Plots/bin3_chi_posterior_combined.png"
            filename_2="./Results/bin3_parameters_result_combined.txt"
        ...
        if tbin==8:
            ...
            Bin1_chi=np.genfromtxt('bin4_chi.txt', comments='#', dtype='S')
            Bin1_Macc=np.genfromtxt('mdot_bin4_logmdot', comments='#', dtype='S')
            filename_1="./Results/bin4_vsini_result_combined.txt"
            plot_="./Plots/bin4_vsini_posterior_combined.png"
            plot_2="./Plots/bin4_B_posterior_combined.png"
            plot_3="./Plots/bin4_Prot_posterior_combined.png"
            plot_4="./Plots/bin4_Macc_posterior_combined.png"
            plot_5="./Plots/bin4_chi_posterior_combined.png"
            filename_2="./Results/bin4_parameters_result_combined.txt"
            databin = np.loadtxt('./Plots/vsini_bin4.txt')

        Bfield=Bin1_B[:,0].astype(float)
        cdf_values=Bin1_B[:,1].astype(float)
        chi=Bin1_chi[:,0].astype(float)
        cdf_values_3=Bin1_chi[:,1].astype(float)
        ########################################
        ...
        for k in range(repetitions):
            ...
            #############################################################################
            random_chi_samples = [sample_random_x(cdf_values_3) for _ in range(num_samples)]
            random_values_chi = [chi_[i] for i in random_chi_samples if i is not None]
            #############################################################################
            ...
            #############################################################################
            params_list = [(Mass[0], random.choice(Pin), j, i, k) for i, j, k in zip(random_values_B,random_values_Macc,random_values_chi)]
            ...
            for item in results:
                Protin, Maccin, B, A, value = item
                result[k].append((Protin, Maccin, B, A))
                vhis[k].append(value)


        result = np.array(result, dtype=object)
        per_histograms = [np.array([item[0] for item in block]) for block in result]
        per = np.concatenate(per_histograms)
        B_histograms = [np.array([item[2] for item in block]) for block in result]
        B = np.concatenate(B_histograms)
        chi_histograms = [np.array([np.log10(item[3]) for item in block]) for block in result]
        X = np.concatenate(chi_histograms)
        Ma_histograms = [np.array([np.log10(item[1]) for item in block]) for block in result]
    ...
    ########################################################################################################
        ...
        comb_1_chi, comb_2_chi, comb_3_chi, comb_4_chi = combine_histograms(-2,-0.22,11, repetitions, chi_histograms)
        comb_1_Ma, comb_2_Ma, comb_3_Ma, comb_4_Ma = combine_histograms(-10,-6, 10, repetitions, Ma_histograms)
        ...
        if tbin==8:
            plt.title(f'Bin 4')
        plt.bar(comb_1_chi, comb_2_chi, width=comb_3_chi, color='blue', alpha=0.2, yerr=comb_4_chi, capsize=5, align='edge', label='Models')
        plt.ylim(0,)
        plt.xlabel(r"$\log(\chi_{\ast})$")
